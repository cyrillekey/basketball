...
<body>
    ...
    <div class="super_container">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-right">
                            <div class="logo-container">
                                <a href="#">Sports<span>Jerseys</span></a>
                            </div>
                            <nav class="navbar">
                                ...
                                <ul class="navbar_user">
                                    ...
                                    <li class="checkout">
                                        <a href="#" id="cart" >
                                            <i  class="fa fa-shopping-cart"></i> <span id="checkout_items" class="checkout_items">23</span>
                                        </a>
                                    </li>
                                </ul>
            ...
            <div class="hamburger_menu">
                ...
                <div class="hamburger_menu_content text-right">
                    <ul class="menu_top_nav">
                        ...
                        <li class="menu_item"><a href="">home</a></li>
                        <li class="menu_item"><a href="">away</a></li>
                        <li class="menu_item"><a href="">2hy</a></li>
                        <li class="menu_item"><a href="">home</a></li>
                        <li class="menu_item"><a href="">home</a></li>    
                    </ul>
        ...
        <!-- Slider -->
<div class="main_slider" style="background-image:url(image/project-290-P9xpYfUpoZI-unsplash.jpg);">
                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                style="background-image: url(image/project-290-P9xpYfUpoZI-unsplash.jpg);">
                                <div class="content">
                                    ...
                                    <h3><span>Now Only</span> ksh 1500</h3>
                                    <div class="button">
                            ...
                            <!-- Start Single Slider -->
                            <div class="single-slider"
                                style="background-image: url(image/eddy-lackmann-7YyZFaNKuLQ-unsplash\(1\).jpg);">
                                <div class="content">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua.</p>
                                    <h3><span>Combo Only:</span> ksh 1300.00</h3>
                                    <div class="button">
                                        <a href="product-grids.html" class="btn">Shop Now</a>
                                    </div>
                                </div>
                            ...
                            <div class="single-slider"
                                style="background-image: url(image/andre-hunter-RPKdvPcYAUo-unsplash.jpg);">
                                <div class="content">
                                    <h2><span>Big Sale Offer</span>
                                        Get the Best Deal on CCTV Camera
                                    </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-4 mb-30">
                            <div class="single-cta">
                                ...
                                <div class="cta-text">
                                    <h4>Mail us</h4>
                                    <a href="cyrilleotieno7@gmail.com"><span>cyrilleotieno7@gmail.com</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
